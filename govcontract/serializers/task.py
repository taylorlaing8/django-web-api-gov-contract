...
class TaskSingleSerializer(serializers.ModelSerializer):
    title = serializers.CharField(max_length=255)
    sub_title = serializers.CharField(max_length=255, allow_null=True)
    slug = serializers.CharField(max_length=255)
    status = serializers.CharField(max_length=2)
    ...
    def to_representation(self, instance):
        ...
        return super(TaskSingleSerializer, self).to_representation(instance)
...
class TaskListSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Task
        fields = ('id', 'title', 'sub_title', 'slug', 'status', 'task_id', 'contract_id', 'order_id', 'comments', 'tasks')
